...
public class NotificationService {
	...
	public void sendDailyIncomeExpenseReminder() {
		...
		emailService.sendEmail(profile.getEmail(),"Daily remminder:Add your income and expenses",body);
	...
	table.append("</table>");
	String body = "Hi "+profile.getFullName()+",<br/><br/> Here is s summary of your expenses for today:<br/><br/>"+table+"<br/><br/> Best regards,<br/>Money Manager Team";
		emailService.sendEmail(profile.getEmail(),"Your daily Expense summary",body);
		}
		
		}
		
		log.info("Job completed: sendDailyIncomeExpenseSummary()");
	}
